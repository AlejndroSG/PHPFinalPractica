<main class="text-center">
    ...
    <?php
        ...
        echo "<tr><th>Amigo</th><th>Juego</th><th>Fecha</th><th>Devuelto</th><th>Devolver</th></tr>";
        foreach ($prestamos as $key => $value) {
            $disabled = ($value[5] == 1) ? " disabled" : "";
            echo "<tr><td>$value[1]</td><td>$value[2] <img src='$value[3]' class='img-fluid'></td><td>$value[4]</td><td>$value[5]</td>
